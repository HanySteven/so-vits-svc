...
def get_hparams(init=True):
    ...
    parser.add_argument('-c', '--config', type=str, default=os.path.join('.', 'configs', 'base.json'),
    ...
    if init:
        with os.open(config_path, os.O_RDONLY) as f:
            config = json.load(f)

        with os.open(config_save_path, os.O_WRONLY) as f:
            json.dump(config, f)
    else:
        with os.open(config_save_path, os.O_RDONLY) as f:
            config = json.load(f)
